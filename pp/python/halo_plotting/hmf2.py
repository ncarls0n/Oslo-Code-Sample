...
files = (r'/mnt/scratch-lustre/njcarlson/peak-patch-runs/23.04.29_LIM_prod'
    +r'uction_runs/ng{0}_cenz7150_C{1}/output/500Mpc_n432_nb'
    +r'74_nt3_merge.pksc.13579_M_gt_{2}Msol')
s   = '_mlambda'
a_e = np.array([ 8.482, 19.09, 33.93, 53.02, 76.34 ])
halo_cats = [ files.format( 0, ''    , '1.129e+11' ) ,
              files.format( 7, s+'10_sigmag', '1.129e+11' ) ,
              files.format( 7, s+'15_sigmag', '1.129e+11' ) ,
              files.format( 7, s+'20_sigmag', '1.129e+11' ) ,
              files.format( 7, s+'25_sigmag', '1.129e+11' ) ,
              files.format( 7, s+'30_sigmag', '1.129e+11' ) ]
...
for i in range(len(halo_cats)):
    ...
    if i==0:
        ...
        label=r'$\lambda_\chi v^2 H_e^{{-2}} = {0}$'.format(a_e[i-1])
...
outfile = '/cita/d/www/home/njcarlson/cifar_meeting/n_of_m_vs_mlambda.pdf'
