...
if fieldtype=='delta' or fieldtype=='deltag':
    fieldlist=deltafile
elif fieldtype=='zetag':
    fieldlist=zetagfile
elif fieldtype=='zetang':
    fieldlist=zetafile
...
# Plot Gaussian component of overdensity field
    ...
    print('{0}plots/deltag.png'.format(run_dir))
