...
module extension
  ...
  ! getArgument      : emulates get_command_argument
  ! nArguments       : emulates command_argument_count
  !
...
#ifdef NAG
  USE f90_unix, ONLY : command_argument_count, get_command_argument, exit
#endif
!VF  USE dflib, ONLY : nargs, get_command_argument
...
!  end function
!
!  subroutine get_command_argument (num, res)
...
!#endif
    ...
    function nArguments() result(narg)
      ...
      narg = command_argument_count() - arg_shift
...
!       character(len=200) :: name1
    ...
    subroutine getArgument(index, argument)
      ...
      ! ===========================================================
      i1 = index + arg_shift
      call get_command_argument(i1, argument)
