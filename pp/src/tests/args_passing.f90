...
subroutine run_hpkvd
  ...
  parameters_filename  = s256arg(3, "parameters.ini")
  !parameters_filename = "parameters.ini"
  !write(*,*) "BEFORE get_command_argument"
  write(*,*) "maketable_flag:      ", maketable_flag 
  write(*,*) "seedFFT:             ", seedFFT  
  write(*,*) "parameters_filename: ", parameters_filename  
  ...
  !write(*,*) "AFTER get_command_argument"
  !write(*,*) "maketable_flag:      ", maketable_flag 
  !write(*,*) "seedFFT:             ", seedFFT  
  !write(*,*) "parameters_filename: ", parameters_filename  
